...
eqsys = EquilibriumSystem(['C','Ca', 'Na', 'Cl', 'Mg', 'N'], from_elements=True, activity_model="DEBYE")
elements_balance = {'Ca':0.028, 'C':0.065, 'Na':0.075, 'Cl':0.056, 'Mg':0.02, 'N':0.01}
...
#raise KeyError
solution2, res = eqsys.solve_equilibrium_elements_balance_phases(TK, elements_balance, tol=1e-12,
                                                                 has_gas_phases=True)
