...
import pyequion2
eqsys = pyequion2.EquilibriumSystem(['Na', 'Cl'], from_elements=True) #We set up the feed components of our system
molal_balance = {'Na':0.065, 'Cl':0.065} #Set up the balances
eqsys.update_system(eqsys.reactions[1:])
